...
public class BMByteMatcher implements ByteMatcher {
    /**
     ...
     */
    public BMByteMatcher(String pattern) {
     ...
     */
    public BMByteMatcher(byte[] pattern) {
     ...
     */
    public BMByteMatcher(byte[] pattern, int offset, int length) {
     ...
     * search algorithm.
     *
     * @param bytes Array of bytes in which to search
     *                   for the pattern.
    ...
    public boolean match(byte[] bytes) {
        return match(bytes, 0, bytes.length);
    }
    ...
    public boolean match(byte[] bytes, int offset, int len) {
        ...
        return (search(bytes, offset, len) != -1);
    }
