/* Generated By:JavaCC: Do not edit this line. SieveParserTokenManager.java */
         ...
         MatchLoop: do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 3:
                  ...
                  break;
               case 1:
                  if ((0x288000002880L & l) != 0L && kind > 11)
                     kind = 11;
                  break;
               case 5:
               case 6:
...
null, null, null, null, null, "\73", "\173", "\175", "\50", "\54", "\51", "\133", 
"\135", };
...
public SieveParserTokenManager(SimpleCharStream stream){
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public SieveParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
